...
<head>
    ...
    <style>
            ...
            h1 {  margin: 10px auto 10px auto; text-align: center; color: #0a0a0a;  }
            .pranav{
    ...
    <div class="container" style="margin-top: 10px;">
        ...
        while ($row=mysqli_fetch_array($r)) {
            ...
            $Hinh = "<a class='btn update' href='#editModal$picture_id'data-toggle='modal'>
                            <img height='400px' width='500px' style='margin:0px 8px;' src='images/img$picture_id.jpg' data-toggle='modal' data-target='#myModal'></a>";
            echo $Hinh; ?>
            ...
            $Hinh = "<img style='text-align:center;' height='180px' width='180px' src='images/stud_img$sid.jpg'/>";
            echo $Hinh; ?>
                                    </div>
